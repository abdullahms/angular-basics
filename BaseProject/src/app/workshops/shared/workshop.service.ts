...
export class WorkshopService {
  ...
  getWorkshops(): Observable<IWorkshop[]> {
    let subject = new Subject<IWorkshop[]>();
    setTimeout(() => {
      subject.next(WORKSHOPS);
      subject.complete();
    }, 1000);
    return subject;
  }
...
const WORKSHOPS: IWorkshop[] = [
  {
    ...
    date: new Date('9/26/2036').toDateString(),
    time: '10:00 am',
    price: 599.99,
  ...
  },
  {
    id: 2,
    name: 'ng-nl',
    date: new Date('4/15/2037').toDateString(),
    time: '9:00 am',
    price: 950.00,
    ...
    //   country: 'Netherlands'
    // }
    onlineUrl: 'http://NLConvention.com',
    sessions: [
      {
        id: 1,
  ...
  },
  {
    id: 3,
    name: 'ng-conf 2037',
    date: new Date('5/4/2037').toDateString(),
    time: '9:00 am',
    price: 759.00,
  ...
  },
  {
    ...
    date: new Date('6/10/2037').toDateString(),
    time: '8:00 am',
    price: 800.00,
  ...
  },
  {
    id: 5,
    name: 'ng-vegas',
    date: new Date('2/10/2037').toDateString(),
    time: '9:00 am',
    price: 400.00,
